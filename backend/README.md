...
## Project Structure
    ...
    ├── testapiautocatalog_117111  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_117111`
...
2. Clone this repo and `cd testapiautocatalog_117111`
